    ...
    <>
      <div className='flex flex-col justify-center items-center h-[500px]'>
        ...
        <div className={cn('md:flex transition-all duration-500', process >= Process.DESCRIBE ? '' : 'scale-0 opacity-0')}>
          <Image src={Hato} alt='Hato' width={200} height={200} className='mx-auto md:mx-0'></Image>
                  ...
                  <li key={skill.name}>
                    <Badge>
                      <Popover>
                        ...
                        <PopoverContent className='mt-2' dangerouslySetInnerHTML={{ __html: skill.describe }} />
                      </Popover>
                    </Badge>
                  </li>
                ))}
